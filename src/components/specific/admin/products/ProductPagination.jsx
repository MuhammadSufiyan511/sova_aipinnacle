...
export function ProductPagination({ totalPages, currentPage, setCurrentPage, t }) {
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
          <button
            ...
            className={`inline-flex h-9 min-w-9 items-center justify-center rounded-full px-3 text-[0.72rem] font-bold transition ${currentPage === pageNumber
