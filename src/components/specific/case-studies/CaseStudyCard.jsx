...
export function CaseStudyCard({ study }) {
  ...
  return (
    <article className="case-study-shell rounded-[36px] border border-[#E2EFEA] bg-white p-5 shadow-[0_12px_44px_rgba(0,0,0,0.03)] sm:p-8">
      <div className="grid gap-6 lg:grid-cols-[0.95fr_2.2fr]">
        <div className="case-study-image-wrapper overflow-hidden rounded-[28px] border border-[#E2EFEA] bg-[#F8FAFC]">
          <img
            src={study.image}
        ...
        <div className="case-study-content-wrapper rounded-[28px] border border-[#E2EFEA] bg-[#f0faf6] p-7 sm:p-8">
          ...
          <div className="mt-7 flex flex-wrap gap-2.5">
            {study.metrics.map((metric) => (
              <span
                key={metric}
                className="case-study-metric-tag rounded-full border border-[#DCEEE7] bg-white px-4 py-2 text-[0.78rem] font-bold text-[#10B981] shadow-sm"
              >
                {metric}
              </span>
            ))}
      ...
      <div className="mt-4 grid gap-5 lg:grid-cols-3">
        <div className="case-study-detail-box rounded-[24px] border border-[#E2EFEA] bg-white p-6">
        ...
        <div className="case-study-result-box rounded-[24px] border border-[#E2EFEA] bg-[linear-gradient(135deg,#ECFDF5_0%,#F5F3FF_100%)] p-6">
