            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <div className="space-y-2">
                ...
                <div
                  ...
                  className="group relative flex h-24 w-full cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 transition hover:border-cyan-500 hover:bg-cyan-50/30"
                >
                  {imagePreview ? (
                    mediaType === 'video' ? (
                      ...
                      <div className="flex h-full w-full flex-col items-center justify-center gap-2 rounded-2xl bg-[#F1FBFF] px-4 text-center">
                        <FileText className="h-7 w-7 text-cyan-600" />
                        <span className="line-clamp-2 text-[0.7rem] font-semibold text-slate-600">{mediaName || t('admin.files.item.none')}</span>
                      </div>
                    ) : (
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-slate-400 group-hover:text-cyan-600">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-100 bg-slate-50 px-4 py-3 text-slate-900 placeholder-slate-300 outline-none transition focus:border-cyan-500 focus:bg-white"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full resize-none rounded-xl border border-slate-100 bg-slate-50 px-4 py-3 text-slate-900 placeholder-slate-300 outline-none transition focus:border-cyan-500 focus:bg-white"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={!name.trim()}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-cyan-500 py-4 text-[0.95rem] font-bold text-white shadow-lg shadow-cyan-500/25 transition hover:bg-cyan-600 disabled:bg-slate-200 disabled:shadow-none"
              >
