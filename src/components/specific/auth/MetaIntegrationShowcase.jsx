...
export function MetaIntegrationShowcase({ onOpenModal }) {
  ...
  return (
    <div className="meta-showcase-shell mt-8 w-full border-y border-[#E2EFEA] bg-gradient-to-br from-[#F8FAFC] via-white to-[#F8FAFC] p-6 shadow-[0_12px_44px_rgba(0,0,0,0.03)] sm:mt-12 sm:rounded-[40px] sm:border sm:p-10 lg:col-span-2 lg:p-14">
      <div className="grid items-center gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:p-4">
        <div>
          ...
          <div className="mt-10 space-y-4">
            {localizedSteps.map((step, index) => (
              <div key={step} className="meta-showcase-step flex items-start gap-4 rounded-[22px] border border-[#E2EFEA] bg-white px-5 py-4 text-[0.95rem] font-bold text-[#0F172A] shadow-sm sm:items-center sm:px-6 sm:py-5 sm:text-[1.1rem]">
        ...
        <div className="meta-showcase-phone-shell mt-10 rounded-[32px] border border-[#334155] bg-[#0F172A] p-2 shadow-[0_32px_80px_rgba(0,0,0,0.2)] sm:mt-0 sm:rounded-[40px]">
