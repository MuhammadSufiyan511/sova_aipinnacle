...
export function HowItWorksCard({ isMetaStep = false, isLoaded, onLoad, step, title, videoUrl }) {
  return (
    <MotionDiv
      ...
      className="group relative flex h-full min-h-[40px] flex-col self-stretch overflow-hidden rounded-[28px] border border-[#E2EFEA] bg-white p-8 shadow-[0_8px_36px_rgba(30,41,59,0.04)] transition-all hover:-translate-y-1 hover:border-[#10B981]/40 hover:shadow-[0_12px_48px_rgba(16,185,129,0.1)]"
    >
      <div
