...
export function ActiveUsersCard({ cardCopy, microCopy }) {
  return (
    ...
    >
      <div className="inner-sim-box mb-8 flex h-48 w-full flex-col items-center justify-center gap-3 rounded-2xl bg-[#FFF8F8] p-5">
        {[
          ...
          { name: 'Johnny Parker', color: '#FFFFFF' },
            ...
            <MotionDiv
              ...
              className="chat-bubble-received flex w-full items-center gap-3 rounded-xl border border-[#E2EFEA] p-3 shadow-sm"
              style={{
                zIndex: i,
