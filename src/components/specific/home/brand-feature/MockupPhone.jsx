...
export const MockupPhone = memo(function MockupPhone({ mockupY, mockupOpacity, mockupScale, mockupRotate, copy, chatLoopDuration, isMobile }) {
  return (
    <MotionDiv
      style={{
        y: mockupY,
      ...
      className={`relative z-10 w-full max-w-[260px] sm:max-w-[340px] mx-auto ${isMobile ? '' : 'drop-shadow-[0_20px_50px_rgba(16,185,129,0.15)]'}`}
    >
      ...
      >
        ...
        >
          ...
          <ChatScreen copy={copy} chatLoopDuration={chatLoopDuration} isMobile={isMobile} />
        </div>
      </motion.div>
