        ...
        {features.map((feature, index) => {
          ...
          return (
            <MotionDiv
              ...
              className="rounded-[26px] border border-[#dfebe9] bg-[linear-gradient(145deg,#ecfeff_0%,#ffffff_55%,#f4f0ff_100%)] p-5 shadow-[0_16px_38px_rgba(15,23,42,0.06)]"
            >
              <h3 className="font-display text-[1.45rem] font-semibold tracking-[-0.05em] text-[#173247] sm:text-[1.55rem]">
                {feature.title}
              </h3>
