    ...
    <MotionDiv whileHover={{ y: -5 }} className="feature-card-glass md:col-span-2 flex flex-col justify-between rounded-[32px] border border-[#E2EFEA] bg-white p-7 shadow-[0_12px_44px_rgba(0,0,0,0.03)] transition-shadow hover:shadow-[0_20px_60px_rgba(16,185,129,0.1)]">
      ...
      <div className="mt-3 flex items-end justify-between gap-4">
        <motion.div animate={featureImageAnimations[0]} transition={featureImageTransition(4.8)} whileHover={{ scale: 1.04, y: -6 }} className="relative w-full max-w-[220px]">
          ...
          <img src={image} alt={feature?.title} loading="lazy" decoding="async" className="relative h-24 w-full rounded-2xl object-cover shadow-[0_14px_30px_rgba(16,185,129,0.12)]" />
        </motion.div>
    ...
    <MotionDiv whileHover={{ y: -5 }} className="feature-card-glass card-automation flex flex-col justify-between rounded-[32px] bg-gradient-to-br from-[#A78BFA] to-[#8B5CF6] p-7 text-white shadow-[0_20px_50px_rgba(167,139,250,0.3)]">
      ...
      <div className="mt-3 flex justify-end">
        <motion.div animate={featureImageAnimations[1]} transition={featureImageTransition(4.4, 0.15)} whileHover={{ scale: 1.05, y: -6 }} className="relative w-full max-w-[120px]">
          ...
          <img src={image} alt={feature?.title} loading="lazy" decoding="async" className="relative h-24 w-full rounded-2xl object-cover shadow-[0_16px_32px_rgba(76,29,149,0.2)]" />
        </motion.div>
      </div>
    </MotionDiv>
  )
    ...
    <MotionDiv whileHover={{ y: -5 }} className="feature-card-glass md:row-span-2 flex flex-col rounded-[32px] border border-[#E2EFEA] bg-white p-7 shadow-[0_12px_44px_rgba(0,0,0,0.03)]">
      ...
      <div className="mt-8 flex flex-1 items-center justify-center">
        <motion.div animate={featureImageAnimations[2]} transition={featureImageTransition(5)} whileHover={{ scale: 1.02, y: -8 }} className="relative h-full w-full">
          ...
          <img src={image} alt={feature?.title} loading="lazy" decoding="async" className="relative h-full max-h-[280px] w-full rounded-[24px] object-cover shadow-[0_20px_38px_rgba(245,158,11,0.14)]" />
        </motion.div>
      </div>
    </MotionDiv>
  )
  ...
  return (
    <MotionDiv whileHover={{ y: -5 }} className="feature-card-glass flex flex-col justify-between rounded-[32px] border border-[#E2EFEA] bg-white p-7 shadow-[0_12px_44px_rgba(0,0,0,0.03)]">
      ...
      <div className="mt-3 flex h-26 w-full items-center justify-center rounded-2xl bg-gradient-to-t from-[#F8FAFC] to-transparent">
        <motion.div animate={featureImageAnimations[5]} transition={featureImageTransition(4.3, 0.12)} className="flex h-20 w-36 items-center justify-center overflow-hidden rounded-xl border border-purple-200 bg-purple-500/10" whileHover={{ scale: 1.05, y: -6 }}>
