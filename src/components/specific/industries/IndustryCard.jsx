...
export function IndustryCard({ industry, index }) {
  ...
  return (
    <MotionSection
      ...
      className={`industry-card-shell grid items-center gap-8 rounded-[32px] border border-[#E2EFEA] bg-white p-8 shadow-[0_12px_44px_rgba(0,0,0,0.03)] lg:grid-cols-2 ${reverse ? 'lg:[&>*:first-child]:order-2' : ''}`}
    >
      <div className="industry-image-wrapper overflow-hidden rounded-[24px] bg-[#F8FAFC]">
        <img
          src={industry.image}
      ...
      <div className="rounded-[24px] bg-white p-2 industry-content-box">
        ...
        <div className="industry-usecase-box mt-8 rounded-[24px] border border-[#E2EFEA] bg-[#e6faf3] p-6">
