...
export function HeaderLanguageSelector({
  ...
  return (
    <div ref={languageMenuRef} className="language-selector-wrapper relative z-[120]">
      <button
        type="button"
        onClick={(event) => {
        ...
        className="language-selector-button relative z-[121] flex h-10 items-center gap-2 rounded-[12px] border border-[#ECFDF5] bg-white/80 px-3 text-[0.8rem] font-semibold text-[#1E293B]"
      >
      ...
      {languageOpen && (
        <div
          className="language-selector-dropdown pointer-events-auto absolute right-0 top-[118%] z-[122] w-[220px] rounded-[14px] border border-[#E2EFEA] bg-white py-2 shadow-[0_24px_60px_rgba(30,41,59,0.14)]"
