export const onboarding = {
  business: {
    title: 'आप किस प्रकार का {emerald:व्यवसाय} चलाते हैं?',
  ...
  products: {
    title: 'अपने {emerald:उत्पाद} जोड़ें',
  ...
  tone: {
    title: 'SOVA का {emerald:व्यक्तित्व} चुनें',
  ...
  loader: {
    title: 'आपका {emerald:AI सेल्स एजेंट} तैयार हो रहा है',
