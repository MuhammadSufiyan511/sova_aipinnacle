  ...
  addProductOverview: {
    ...
    sections: {
      ...
      category: {
        ...
        customSubCategoryLabel: 'Custom Category Name',
        customSubCategoryPlaceholder: 'e.g. Special Crafts',
...
admin.addProductOverview = {
  ...
  titleEdit: 'Edit Item',
  subtitleAdd: 'Create a professional listing for your catalog.',
  subtitleEdit: 'Update your item details for better AI replies.',
  backToCatalog: 'Back to Shop Catalog',
  editorInitialising: 'Opening Editor...',
  steps: {
    basics: 'Basic Info',
  ...
  sections: {
    basics: {
      ...
      subtitle: 'Basic details about your item.',
      nameLabel: 'Item Name',
      namePlaceholder: 'e.g. Cotton T-Shirt',
      descriptionLabel: 'Description',
      descriptionPlaceholder: 'Tell your customers about this item...',
      brandLabel: 'Brand Name',
      brandPlaceholder: 'e.g. Local Artisan',
    },
    category: {
      title: 'Classification',
      subtitle: 'Help buyers find your item easily.',
      categoryLabel: 'Main Category',
      categoryPlaceholder: 'Select category',
      subCategoryLabel: 'Item Type',
      subCategoryPlaceholder: 'Select type',
      ...
      customSubCategoryPlaceholder: 'Enter type name',
      customFieldsTitle: 'Additional Details',
    ...
    pricing: {
      ...
      subtitle: 'Set your selling price and check stock.',
      priceLabel: 'Selling Price',
      salePriceLabel: 'Discounted Price',
      salePricePlaceholder: 'Optional',
      stockLabel: 'Total Stock',
      stockPlaceholder: 'Quantity in hand',
      skuLabel: 'Item ID / SKU',
      skuPlaceholder: 'e.g. ITEM-001',
      skuHelp: 'Internal reference code',
      minOrderLabel: 'Minimum Order',
    },
    media: {
      title: 'Item Photos & Media',
      noMediaAttached: 'No photos uploaded',
  ...
  fields: {
    ...
    color: { label: 'Color', placeholder: 'e.g. Royal Blue' },
    fabric: { label: 'Fabric/Material', placeholder: 'e.g. Silk' },
    fit: { label: 'Fit Type', placeholder: 'e.g. Slim Fit' },
    pattern: { label: 'Pattern', placeholder: 'e.g. Floral' },
    ageRange: { label: 'Age Group', placeholder: 'e.g. 5-8 years' },
    gender: { label: 'Gender', placeholder: 'Select gender' },
    purity: { label: 'Gold Purity', placeholder: 'e.g. 22K' },
    weight: { label: 'Weight', placeholder: 'e.g. 10g' },
    brand: { label: 'Brand', placeholder: 'e.g. Samsung' },
    storage: { label: 'Storage Cap.', placeholder: 'e.g. 128GB' },
    ram: { label: 'RAM Size', placeholder: 'e.g. 8GB' },
    processor: { label: 'Processor', placeholder: 'e.g. Core i7' },
    subject: { label: 'Subject', placeholder: 'e.g. Biology' },
    origin: { label: 'Country of Origin', placeholder: 'e.g. Saudi Arabia' },
  },
  categories: {
    ...
    decoration: 'Home & Event Decor',
    books_stationary: 'Books & Stationary',
    medical_instruments: 'Medical Tools',
    surgical_instruments: 'Surgical Tools',
  ...
  subcategories: {
    ...
    'kids-wear': 'Kids & Baby Wear',
    abayas: 'Abayas & Modest Wear',
    ...
    'raw-nuts': 'Raw Nuts',
    'dried-berries': 'Dried Fruits',
    'dates-varieties': 'Premium Dates',
    'seeds-mix': 'Seeds & Mixes',
    'home-decor': 'Home Decor',
    'wall-art': 'Wall Art',
    lighting: 'Lighting',
    'event-decor': 'Event Decor',
    'academic-books': 'Academic Books',
    'fiction-nonfiction': 'Fiction & Stories',
    'stationary-office': 'Office Stationary',
    'art-supplies': 'Art Supplies',
    'writing-instruments': 'Pens & Sets',
    diagnostics: 'Diagnostic Tools',
    monitoring: 'Patient Monitors',
    'rehab-mobility': 'Mobility Aids',
    respiratory: 'Oxygen/Nebulizers',
    'general-surgery': 'General Surgery',
    'dental-instruments': 'Dental Tools',
    'orthopedic-surgery': 'Orthopedic Tools',
    'ophthalmic-surgery': 'Eye Surgery Tools',
    'power-tools': 'Power Tools',
    'hand-tools': 'Hand Tools',
    'plumbing-hardware': 'Plumbing Hardware',
    'electrical-hardware': 'Electrical Hardware',
    'aerial-rockets': 'Aerial Rockets',
    'multi-shot-cakes': 'Fireworks Cakes',
    'fountains-wheels': 'Fountains & Wheels',
    'ground-fireworks': 'Ground Fireworks',
    'general-merchandise': 'General Items',
