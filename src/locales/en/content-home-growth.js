...
export const pricing = {
  plans: [
    { name: 'SOVA Basic', price: '$18', blurb: 'Small single-location shops', points: ['Up to 50 products in catalog', '1,000 AI replies/month', 'Basic price & availability answers', 'Roman Urdu support'] },
    { name: 'SOVA Pro', tierInclude: 'Everything in Basic PLUS', price: '$43', blurb: 'Busy retailers, restaurants', points: ['Up to 500 products', '5,000 AI replies/month', 'Full analytics dashboard', 'Trending items report', 'Customer sentiment analysis', 'Photo catalog integration'], badge: 'Popular' },
    { name: 'SOVA Enterprise', tierInclude: 'Everything in Pro PLUS', price: 'Custom', blurb: 'Wholesalers, industrialists, large firms', points: ['Unlimited products', 'Multiple branches/locations', 'Custom integrations with internal software', 'Priority support', 'Dedicated account manager', 'Custom AI training'], badge: 'Enterprise', cta: 'Contact Us' },
  ],
}
