...
function LegalPage({ eyebrow, title, description, sections, updatedAt }) {
  return (
    <section className="mx-auto max-w-[1100px] py-14">
      ...
      <p className="mt-4 text-center text-sm font-medium text-slate-500">Last updated: {updatedAt}</p>
        ...
        {sections.map((section) => (
          ...
          >
            <div className="flex items-center gap-4">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#ccfbf1_0%,#fef3c7_100%)] text-slate-900">
