    ...
    <section className="mx-auto max-w-[1280px] py-14">
          ...
          <div
            ...
            className={`rounded-[32px] border p-7 shadow-[0_24px_60px_rgba(15,23,42,0.08)] ${
              index === 0
                ...
                : 'border-[#cfe6e9] bg-white'
            }`}
          >
            <div className="flex items-center justify-between gap-4">
              <div>
                <h2 className="font-display text-3xl font-semibold tracking-[-0.04em] text-[#173247]">
                  {plan.name}
                </h2>
                <p className="mt-2 text-sm leading-7 text-[#4e6b79]">{plan.blurb}</p>
              </div>
              {plan.badge ? (
            ...
            <div className="mt-8 flex items-end gap-2">
              <span className="font-display text-5xl font-semibold tracking-[-0.05em] text-[#173247]">{plan.price}</span>
              <span className="pb-2 text-sm text-[#0f9f8f]">/ month</span>
            </div>
            <div className="mt-8 space-y-4">
              {plan.points.map((point) => (
                <div key={point} className="flex items-center gap-3 text-sm text-[#305365]">
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-[32px] border border-[#cfe6e9] bg-white p-7 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#0f9f8f]">Included in every plan</p>
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={item} className="rounded-[24px] bg-[#f4fbfb] px-5 py-4 text-sm font-medium text-[#305365]">
                {item}
              </div>
            ))}
          </div>
        ...
        <div className="rounded-[32px] bg-[linear-gradient(135deg,#0f172a_0%,#1d4ed8_60%,#10b981_120%)] p-7 text-white shadow-[0_24px_60px_rgba(15,23,42,0.14)]">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/8 px-3 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-white">
      ...
      <div className="mt-8 flex justify-center">
        <Link to="/terms" className="text-sm font-semibold text-[#0f9f8f] transition hover:text-[#173247]">
