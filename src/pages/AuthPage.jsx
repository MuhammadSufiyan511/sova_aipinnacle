  ...
  return (
    <>
      <section className="mx-auto max-w-[1280px] py-16">
        <div className="grid gap-6 rounded-[40px] border border-[#cfe6e9] bg-white p-6 shadow-[0_32px_80px_rgba(15,23,42,0.1)] lg:grid-cols-[0.92fr_1.08fr] lg:p-8">
          <div className="rounded-[32px] bg-[linear-gradient(160deg,#0f172a_0%,#1d4ed8_55%,#10b981_130%)] p-8 text-white">
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-white">Meta only access</p>
          ...
          <div className="flex items-center">
            <div className="w-full rounded-[32px] bg-[#f4fbfb] p-6 sm:p-8">
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#0f9f8f]">Account access</p>
              <h2 className="mt-4 font-display text-3xl font-semibold tracking-[-0.04em] text-[#173247]">Continue with Meta</h2>
              <p className="mt-4 text-sm leading-7 text-[#4e6b79]">Use your Meta-connected business identity to continue. This page combines login and signup in one smooth flow.</p>
              ...
              <p className="mt-3 text-center text-sm text-[#6b8795]">No card required</p>
              <button type="button" className="mt-6 text-sm font-semibold text-[#4e6b79] transition hover:text-[#173247]">Forgot Password</button>
              <div className="mt-8 rounded-[24px] border border-[#cfe6e9] bg-white p-5">
                <div className="flex items-center gap-3 text-sm font-semibold text-[#173247]"><ShieldCheck className="h-5 w-5 text-teal-600" />Meta-first login only</div>
                <p className="mt-3 text-sm leading-7 text-[#4e6b79]">We keep the access flow clear and low-friction for business owners who mainly work from mobile.</p>
              </div>
            </div>
          </div>
